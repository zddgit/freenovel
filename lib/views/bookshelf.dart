...
import 'package:freenovel/views/Detail.dart';
...
class _BookshelfState extends State<Bookshelf>{
  ...
  void initState() {
    ...
    novels = <Novel>[
      Novel(1,"images/3773s.jpg","三寸人间","耳根","星空古剑，万族进化，缥缈道院，谁与争锋天下万物，神兵不朽，宇宙苍穹，太虚称尊青木年华，悠悠牧之",null),
...
class Novel{
  ...
  Novel(this._id,this._imageUrl, this._name, this._author, this._introduction,this._recentReadTime);
